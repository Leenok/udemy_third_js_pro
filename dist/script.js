...
class Form {
  constructor(forms) {
    ...
    this.path = 'asseets/question.php';
  }
  clearInputs() {
...
class MainSlider extends _slider__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  showSlides(n) {
    ...
    for (const child of this.slides) {
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  feedSlider.init();
  const player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.showup .play', '.overlay').init();
  const playerPage2 = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__video-item .play', '.overlay').init();
